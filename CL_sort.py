...
parser.add_argument("-m", "--max-page", default = 5, type = int, help = "Set max page count for reading pdf files")
parser.add_argument("-t", "--text-max", default= 12000, type = int, help = "Maximum amount of text that can be extract form a file")
parser.add_argument("-d", "--doc-img", action = "store_true", help="Extract data from image inside a doc file")
parser.add_argument("-p", "--show-path", action = "store_true", help="Show file's path while program running")
parser.add_argument("-i", "--image-size", default = 500, type = int, help = "Image size when extrcting image files")
